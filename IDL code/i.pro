...
source_one_flux = [0.0,0.0]
source_two_flux = [0.0,0.0]
source_three_flux = [0.0,0.0]
...
for x=0, 99 do begin
    for y=0, 99 do begin
        ...
        if ((source_index(0) gt 99) or (source_index(0) lt 0)) or ((source_index(1) gt 99) or (source_index(1) lt 0)) then begin
            ...
            source_one_flux[0] += value
            if ((x-50)^2 + (y-50)^2) le 40^2 then source_one_flux[1] += value else source_one_flux[1] += 0.0
        ...
        if ((source_index(0) gt 99) or (source_index(0) lt 0)) or ((source_index(1) gt 99) or (source_index(1) lt 0)) then begin
            ...
            source_two_flux[0] += value
            if ((x-50)^2 + (y-50)^2) le 40^2 then source_two_flux[1] += value else source_two_flux[1] += 0.0
        ...
        if ((source_index(0) gt 99) or (source_index(0) lt 0)) or ((source_index(1) gt 99) or (source_index(1) lt 0)) then begin
            ...
            source_three_flux[0] += value
            if ((x-50)^2 + (y-50)^2) le 40^2 then source_three_flux[1] += value else source_three_flux[1] += 0.0
...
;(i)
;Tell the user what percentage of the signal from each source fell into the "zero" region outside the circle.
;For that last bit, you can use your knowledge of the source location, normalisation and sigma
print, 'source one percentage'
print, source_one_flux[1]/source_one_flux[0]

print, 'source two percentage'
print, source_two_flux[1]/source_two_flux[0]

print, 'source three percentage'
print, source_three_flux[1]/source_three_flux[0]
